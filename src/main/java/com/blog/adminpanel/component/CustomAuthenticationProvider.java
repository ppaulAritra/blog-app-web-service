...
import com.blog.adminpanel.domain.Authority;
import com.blog.adminpanel.domain.User;
  ...
  implements AuthenticationProvider {
    ...
    private String baseUrl;
 	...
 	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
 		...
 		params.add("client_id", "blogapp-client");
 		params.add("client_secret", "blogapp-secret" );
 		...
 		try {
			...
			if(response.getBody().getIsApproved().equals("false"))
			{
				throw new BadCredentialsException("Your Account is not approved yet. Please Contact Administrator");
			}
